...
const PlaceOrder = () => {
	...
	const [discount, setDiscount] = useState(0) // Discount aplicat
	...
	const validatePromoCode = () => {
		...
		const validPromoCodes = { DISCOUNT10: 10, SALE20: 20 ,BLAKFRIDAY: 40}
		if (validPromoCodes[promoCode]) {
			setDiscount(validPromoCodes[promoCode])
			toast.success(
				`Cod promoțional aplicat: ${validPromoCodes[promoCode]}% reducere!`
			)
		} else {
			setDiscount(0)
